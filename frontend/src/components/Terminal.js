...
const Terminal = ({ logs, onRunTests }) => {
  ...
  return (
    <div className="flex gap-4 h-full">
      <div className="flex-1 h-full flex flex-col bg-[#1e1e2d] border border-[#2d2d3d] rounded-lg overflow-hidden">
      ...
      <div className="w-80">
        <TestCaseInput onRun={onRunTests} />
      </div>
    </div>
  );
};
